...
Live coding running your Java application on Kubernetes. From implantation to debugging without fear! with specialist Sandro Giacomozzi by DIO (digital innovation one) also available at:
https://dev.to/sandrogiacom/kubernetes-for-java-developers-setup-41nk

## What was built
How to run a microservice application and a docker and orchestrate the deployment with kubernetes.
...
## <span style="color:#6db33f;" >Step 1:</span> Base app
...
## <span style="color:#6db33f;" >Step 2:</span> App on Docker
